...
declare function runSearchesInGuestEngine(absolutePathToFile: string, searchConfiguration?: SearchConfiguration): Promise<ReadonlyMap<string, Graph | null>>;
...
export { LoggingConfiguration, type SearchConfiguration, runSearchesInGuestEngine as default };
