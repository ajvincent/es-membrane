# Stage 2: Code generation using ts-morph-structures' exported library code

# Building a structures set from the stage 1 snapshot
...
## Building the structure classes

1. [Creating](./build/structureUnions.ts) the [structure unions](../stage_1_snapshot/snapshot/source/types/StructureImplUnions.d.ts) and getting the list of structure names.
