...
export class NamedTupleMemberTypeStructureImpl extends TypeStructuresBase<TypeStructureKind.NamedTupleMember> {
  public static clone(
    ...
    const namedTuple = new NamedTupleMemberTypeStructureImpl(
      other.name,
  ...
  public readonly kind: TypeStructureKind.NamedTupleMember =
    TypeStructureKind.NamedTupleMember;
