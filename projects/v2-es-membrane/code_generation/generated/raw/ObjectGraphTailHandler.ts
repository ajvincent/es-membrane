...
import type { ObjectGraphValueCallbacksIfc, ObjectGraphValuesIfc } from "../types/ObjectGraphHeadIfc.js";
import type { ObjectGraphHandlerIfc } from "./types/ObjectGraphHandlerIfc.js";

export default class ObjectGraphTailHandler implements ObjectGraphHandlerIfc, ObjectGraphValueCallbacksIfc {
    protected readonly membrane: MembraneInternalIfc;
    ...
    public apply(shadowTarget: object, thisArg: unknown, argArray: unknown[], nextGraphKey: string | symbol, nextTarget: object, nextThisArg: unknown, nextArgArray: unknown[]): unknown {
        ...
        void(argArray);
        void(nextGraphKey);
        return Reflect.apply(nextTarget as CallableFunction, nextThisArg, nextArgArray);
    }
