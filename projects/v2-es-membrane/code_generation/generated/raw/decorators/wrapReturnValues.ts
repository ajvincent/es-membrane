...
export default function WrapReturnValues(baseClass: typeof ObjectGraphTailHandler, context: ClassDecoratorContext): typeof ObjectGraphTailHandler {
    ...
    class WrapReturnValues extends baseClass {
        ...
        public defineProperty(shadowTarget: object, property: string | symbol, attributes: PropertyDescriptor, nextGraphKey: string | symbol, nextTarget: object, nextProperty: string | symbol, nextAttributes: PropertyDescriptor): boolean {
            const result: boolean = super.defineProperty(shadowTarget, property, attributes, nextGraphKey, nextTarget, nextProperty, nextAttributes);
        ...
        public deleteProperty(shadowTarget: object, p: string | symbol, nextGraphKey: string | symbol, nextTarget: object, nextP: string | symbol): boolean {
            const result: boolean = super.deleteProperty(shadowTarget, p, nextGraphKey, nextTarget, nextP);
            return this.thisGraphValues!.getValueInGraph(result, this.thisGraphKey) as boolean;
        }
        ...
        public getOwnPropertyDescriptor(shadowTarget: object, p: string | symbol, nextGraphKey: string | symbol, nextTarget: object, nextP: string | symbol): PropertyDescriptor | undefined {
            const result: PropertyDescriptor | undefined = super.getOwnPropertyDescriptor(shadowTarget, p, nextGraphKey, nextTarget, nextP);
            return this.thisGraphValues!.getDescriptorInGraph(result, this.thisGraphKey);
        }
        ...
        public getPrototypeOf(shadowTarget: object, nextGraphKey: string | symbol, nextTarget: object): object | null {
            const result: object | null = super.getPrototypeOf(shadowTarget, nextGraphKey, nextTarget);
            return this.thisGraphValues!.getValueInGraph(result, this.thisGraphKey) as object | null;
        }
        ...
        public has(shadowTarget: object, p: string | symbol, nextGraphKey: string | symbol, nextTarget: object, nextP: string | symbol): boolean {
            const result: boolean = super.has(shadowTarget, p, nextGraphKey, nextTarget, nextP);
            return this.thisGraphValues!.getValueInGraph(result, this.thisGraphKey) as boolean;
        }
        ...
        public preventExtensions(shadowTarget: object, nextGraphKey: string | symbol, nextTarget: object): boolean {
            const result: boolean = super.preventExtensions(shadowTarget, nextGraphKey, nextTarget);
            return this.thisGraphValues!.getValueInGraph(result, this.thisGraphKey) as boolean;
        }
        ...
        public setPrototypeOf(shadowTarget: object, v: object | null, nextGraphKey: string | symbol, nextTarget: object, nextV: object | null): boolean {
            const result: boolean = super.setPrototypeOf(shadowTarget, v, nextGraphKey, nextTarget, nextV);
            return this.thisGraphValues!.getValueInGraph(result, this.thisGraphKey) as boolean;
        }
    }
...
WrapReturnValues satisfies ClassDecoratorFunction<typeof ObjectGraphTailHandler, true, false>
;
