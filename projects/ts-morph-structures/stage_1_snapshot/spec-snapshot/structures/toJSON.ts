...
it("toJSON() generally works", () => {
  ...
  classDecl.extendsStructure = new LiteralTypedStructureImpl("Date");

  classDecl.implementsSet.add(new LiteralTypedStructureImpl("NumberStringType"));
  classDecl.implementsSet.add((writer: CodeBlockWriter): void => {
    writer.write("Foo");
  });
