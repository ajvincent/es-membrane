import WeakKeyHash from "../../../source/core/utilities/WeakKeyHash.mjs";

const value0 = {}, value1 = {}, value2 = {}, value3 = {};

describe("WeakKeyHash", () => {
  let hasher;
  ...
  describe(".getKey()", () => {
    ...
    it("builds a hash for each unique dictionary", () => {
      ...
      expect(composite1 instanceof WeakSet).toBe(true);
      ...
      expect(composite2 instanceof WeakSet).toBe(true);
      ...
      expect(composite3 instanceof WeakSet).toBe(true);
